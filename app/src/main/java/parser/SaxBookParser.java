...
public class SaxBookParser implements BookParser{
    ...
    public List<Book> parse(InputStream is) throws Exception {
        SAXParserFactory factory = SAXParserFactory.newInstance();//获得SAXParserFactory实例
        SAXParser parser = factory.newSAXParser(); //从factory获取SAXParser实例
        MyHandler handler = new MyHandler();
        parser.parse(is, handler);  //根据自定义的handler规则解析输入流
    ...
    public String serialize(List<Book> books) throws Exception {
        ...
        transformer.setOutputProperty(OutputKeys.INDENT,"yes"); //是否自动添加额外空白
    ...
    private class MyHandler extends DefaultHandler{
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            ...
            builder.setLength(0); //将字符长度设置为0以便重新开始读取元素内的字符集节点
        }
